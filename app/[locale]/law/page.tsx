...
export default function LawPage() {
  ...
  const lawData = [
    ...
    { 
      label: "商品代金以外の必要料金", 
      value: "システム利用料 10% および 決済手数料（クレジットカード等 3.96% / PayPay 4.378%、合計 13.96〜14.378%）が価格に含まれます。また、本サービスの利用、コンテンツのダウンロード等に必要なインターネット接続費用および通信料はお客様の負担となります。"
    },
    { 
      label: "支払方法", 
      value: "クレジットカード決済、Google Pay、Apple Pay、およびその他Stripeが提供する決済手段（一部イベントではPayPayも対応）を予定しております。対応する決済手段は、ユーザーのデバイスや地域、イベント設定によって異なる場合があります。" 
    },
    { 
      label: "支払時期", 
