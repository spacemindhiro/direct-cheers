-- qr_configs にスライダーステップ単位を追加（100/500/1000 の3択）
ALTER TABLE public.qr_configs
  ADD COLUMN IF NOT EXISTS amount_step INTEGER NOT NULL DEFAULT 100
    CHECK (amount_step IN (100, 500, 1000));

-- create_qr_bundle を p_amount_step 対応版に置き換え
...
-- p_amount_step なし（旧シグネチャ）が残っていれば削除
DROP FUNCTION IF EXISTS create_qr_bundle(UUID,UUID,UUID,TEXT,BOOLEAN,TEXT,TEXT,INTEGER,INTEGER,UUID,TEXT,JSONB,TEXT,INTEGER,BOOLEAN,TEXT,BOOLEAN,TEXT,TEXT,TEXT,TEXT,TIMESTAMPTZ,TIMESTAMPTZ);

REVOKE EXECUTE ON FUNCTION create_qr_bundle(UUID,UUID,UUID,TEXT,BOOLEAN,TEXT,TEXT,INTEGER,INTEGER,UUID,TEXT,JSONB,TEXT,INTEGER,BOOLEAN,TEXT,BOOLEAN,TEXT,TEXT,TEXT,TEXT,TIMESTAMPTZ,TIMESTAMPTZ,INTEGER) FROM PUBLIC, anon, authenticated;
GRANT  EXECUTE ON FUNCTION create_qr_bundle(UUID,UUID,UUID,TEXT,BOOLEAN,TEXT,TEXT,INTEGER,INTEGER,UUID,TEXT,JSONB,TEXT,INTEGER,BOOLEAN,TEXT,BOOLEAN,TEXT,TEXT,TEXT,TEXT,TIMESTAMPTZ,TIMESTAMPTZ,INTEGER) TO service_role;
