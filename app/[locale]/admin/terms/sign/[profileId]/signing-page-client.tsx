      ...
      {types.map((t) => (
        <div key={t} className="space-y-4">
          ...
          {TERMS_CONTENT[t].map((section) => (
            <div key={section.article} className="space-y-1.5">
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans">
      ...
      <div className="max-w-3xl mx-auto px-6 py-8 space-y-8 pb-32">
        ...
        {/* 書面タイトル */}
        <div className="text-center space-y-2 py-4 border-b border-slate-800">
          <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.4em]">Direct Cheers</p>
          <h1 className="text-2xl font-black text-white">利用規約 同意書</h1>
        ...
        {/* 規約全文 */}
        <div className="bg-slate-900 border border-slate-800 rounded-[2rem] px-6 py-6">
