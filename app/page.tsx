  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-pink-500/30">
      ...
      <section id="features" className="py-24 bg-slate-950 px-6">
        ...
        {/* --- JOIN THE MOVEMENT セクション --- */}
        <div className="max-w-6xl mx-auto mt-24 pt-24 border-t border-slate-900 flex flex-col items-center">
          <h4 className="text-white font-black italic tracking-tighter text-3xl mb-12 uppercase text-center">Join the Movement</h4>
          <div className="w-full max-w-md">
            {/* 修正点：エラーの元凶 ConnectSupabaseSteps を削除し、SignUpUserStepsのみに */}
            <SignUpUserSteps />
          </div>
        </div>
      </section>
