      ...
      <section id="features" className="py-24 bg-slate-950 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            ...
            {/* 01: 演出連動 - 期待感を煽る */}
            <div className="p-10 rounded-[2.5rem] bg-slate-950 border border-slate-800 hover:border-pink-500/30 transition-all group">
            ...
            {/* 02: スマホウォレット (ココが主役!) */}
            <div className="p-10 rounded-[2.5rem] bg-gradient-to-br from-slate-900 to-slate-950 border border-violet-500/20 shadow-2xl relative overflow-hidden group">
            ...
            {/* 03: 証跡管理 */}
            <div className="p-10 rounded-[2.5rem] bg-slate-950 border border-slate-800 hover:border-indigo-500/30 transition-all">
