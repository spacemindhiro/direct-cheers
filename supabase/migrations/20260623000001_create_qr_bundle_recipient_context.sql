-- create_qr_bundle を p_recipient_name_context 対応版に置き換え
...
-- p_recipient_name_context なし（旧シグネチャ・24パラメータ）が残っていれば削除
DROP FUNCTION IF EXISTS create_qr_bundle(UUID,UUID,UUID,TEXT,BOOLEAN,TEXT,TEXT,INTEGER,INTEGER,UUID,TEXT,JSONB,TEXT,INTEGER,BOOLEAN,TEXT,BOOLEAN,TEXT,TEXT,TEXT,TEXT,TIMESTAMPTZ,TIMESTAMPTZ,INTEGER);
