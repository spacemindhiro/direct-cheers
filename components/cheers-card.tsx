  ...
  return (
    ...
    >
      ...
      >
        {/* 表面 */}
        <div
          className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-800 via-slate-800 to-slate-900 border border-slate-700 shadow-[0_0_60px_rgba(236,72,153,0.15)]"
        ...
        >
          ...
          {serialNumber != null && (
            <div className="absolute top-4 right-4 flex flex-col items-end">
              ...
              <p
                className="text-2xl font-black text-pink-400 italic tracking-tighter leading-none tabular-nums"
              ...
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="text-left">
                    <p className="text-[10px] font-black text-pink-400 uppercase tracking-widest leading-none">
                      Thanks Gift
                    </p>
                    <p className="text-xs text-slate-400 mt-0.5">
                      {artistName} からお返しが届いています
                    </p>
                  </div>
                </div>
        ...
        {hasThanks && (
          <div
            className="absolute inset-0 overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-slate-900 to-pink-950/30 border border-pink-500/30 shadow-[0_0_60px_rgba(236,72,153,0.2)]"
            style={{
            ...
            <div className="relative p-6 space-y-5 h-full flex flex-col">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Gift size={14} className="text-pink-400" />
                  <p className="text-[9px] font-black text-pink-400 uppercase tracking-[0.35em]">
                    Thanks Gift
                  </p>
                </div>
                <button
              ...
              <div className="flex items-center gap-3">
                {artistAvatar ? (
                  <img
                    src={artistAvatar}
                    alt={artistName}
                    className="w-10 h-10 rounded-xl object-cover ring-2 ring-pink-500/30 shrink-0"
                  />
                ) : (
