...
function OrganizerGuide() {
  return (
    <div className="space-y-4">
      ...
      >
        <ul className="list-disc pl-4 space-y-1">
          <li>「入場スキャナを起動」からカメラでお客様のチケットQRを読み取り、「入場OK」「入場済みです」「無効なチケット」等を即座に判定します</li>
      ...
      >
        <ul className="list-disc pl-4 space-y-1">
          <li>アーティストへの「出演依頼」は、イベントの作成・編集画面の中で行います。コネクション済みのアーティストを選ぶか、名前検索して依頼メッセージを添えて送ります</li>
          <li>「招待管理」は別機能で、新規ユーザーをプラットフォームの「アーティスト」ロールとして招待するリンクを発行する画面です（出演依頼とは別物なのでご注意ください）</li>
        </ul>
      </Section>
      ...
      <div className="bg-slate-800 border border-slate-700 rounded-2xl p-5 space-y-3">
        ...
        <div className="space-y-2">
          ...
          <Faq
            ...
            a="精算前のイベントであれば、イベント詳細の「売上・決済」タブ（決済ログ）から自分のイベントの決済を取り消せます（カード決済はオーソリ取消、PayPayなどは返金）。イベントが「精算済み」になった後の返金は運営（admin）のみが対応します。"
          />
          <Faq
